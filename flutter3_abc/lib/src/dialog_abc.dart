...
class _DialogAbcState extends State<DialogAbc> with BaseAbcStateMixin {
  ...
  List<Widget> buildMenu2(BuildContext context) {
    return <Widget>[
      MenuItemButton(onPressed: onPressed, child: randomTextWidget(length: 5)),
      MenuItemButton(onPressed: onPressed, child: randomTextWidget(length: 5)),
      MenuItemButton(onPressed: onPressed, child: randomTextWidget(length: 5)),
    ];
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(data: newThemeData, child: super.build(context));
  }

  @override
  List<Widget> buildBodyList(BuildContext context) {
    return [
      const Text("Dialog↓", textAlign: TextAlign.center),
      <Widget>[
        ...
        GradientButton.normal(() {
          showDialog(
            ...
            barrierDismissible: AbcConfig.getAndIncrementClickCount() % 2 == 0,
            builder: (context) {
              return Align(
          ...
          showCupertinoDialog(
            ...
            builder: (context) {
              return Container(
                ...
                child: randomTextWidget().wrapTextStyle().container(
                  color: randomColor(),
                ),
              );
            },
      ...
      const Text("Sheet↓", textAlign: TextAlign.center),
      <Widget>[
        GradientButton.normal(() {
          showBottomSheet(
            context: context,
      ...
      <Widget>[
        PopupMenuButton<String>(
          ...
          child: FilledButton(
            onPressed: onPressed,
            child: const Text('menu~', textAlign: TextAlign.center),
          ).ignorePointer(),
        ),
        PopupMenuButton<String>(
          itemBuilder: buildMenu,
        ...
        PopupMenuButton<String>(
          itemBuilder: (context) {
            return <PopupMenuEntry<String>>[
              PopupMenuItem(value: randomText(), child: randomWidget()),
              PopupMenuItem(value: randomText(), child: randomWidget()),
              PopupMenuItem(value: randomText(), child: randomWidget()),
              PopupMenuItem(value: randomText(), child: randomWidget()),
              PopupMenuItem(value: randomText(), child: randomWidget()),
      ...
      [
        GradientButton.normal(() async {
          //循环5s
          final loadingInfoNotifier = LoadingValueNotifier.fromValue(
            LoadingInfo(progress: 0.0, message: "加载中..."),
          );
          showLoading(loadingInfoNotifier: loadingInfoNotifier);
          await for (var i in Stream.periodic(

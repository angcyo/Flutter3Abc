  ...
  Future _connectSocket() async {
    try {
      ...
      socket.listen(
        ...
        onError: (e) {
          //手机App, 切换到后台后会被系统优化(耗电行为控制), 然后触发异常.
          //[SocketException]SocketException: Software caused connection abort (OS Error: Software caused connection abort, errno = 103), address = 192.168.31.219, port = 33214
